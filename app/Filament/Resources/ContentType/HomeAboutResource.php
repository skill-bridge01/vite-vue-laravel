...
use App\Filament\Resources\ContentType\HomeAboutResource\Pages;
use App\CmsPages\Templates\ContentType\HomeAbout as Template;
use Filament\Forms;
use Filament\Tables;
...
class HomeAboutResource extends BaseResource
{
    ...
    protected static string $subSlug = 'cms-homeabout';
    ...
    public static function getPages(): array
    {
        return [
            ...
            'edit' => Pages\EditHomeAbout::route('/{record:id}/edit'),
